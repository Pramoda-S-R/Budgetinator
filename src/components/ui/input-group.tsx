...
function InputGroup({ className, ...props }: React.ComponentProps<"div">) {
	return (
		// biome-ignore lint/a11y/useSemanticElements: input group uses role="group" for AT, not a native fieldset
		<div
...
function InputGroupAddon({
	...
	return (
		// biome-ignore lint/a11y/useSemanticElements: input addon uses role="group" for AT, not a native fieldset
		<div
			role="group"
