	...
	server: {
		handlers: {
			GET: async ({ request }) => {
				...
				type AllocationRow = (typeof allocRows)[number];
				const allocationsMap: Record<string, AllocationRow[]> = {};
				for (const a of allocRows) {
					if (!allocationsMap[a.presetId]) {
						allocationsMap[a.presetId] = [];
					}
